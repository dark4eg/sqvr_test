...
const History = props => {
    ...
    console.log('classes.items', classes.items);
    console.log('classes.cell', classes.cell);
    console.log('classes.cardClass', classes.cardClass);
    console.log('CardComponent', CardComponent);
    console.log('classes.contentCard', classes.contentCard);
    console.log('classes.headerCard', classes.headerCard);
